...
export default function DeleteButton({open, handleOpen, updateSaims, title, message, endpoint, createNotification, errorNotification}: {open: boolean, handleOpen: () => void, updateSaims: () => void, title: string, message: string, endpoint: string, createNotification: Notificatione, errorNotification: Notificatione}) {
