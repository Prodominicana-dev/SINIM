...
export default function page() {
  ...
  return (
    <div className="w-full">
      ...
      <section
        id="datamarket"
        className="flex flex-row w-full h-full py-10 bg-white sm:h-screen"
      >
        <div className="w-6/12 h-full"></div>
        <div className="flex flex-col justify-center w-6/12 h-full ">
          <div className="w-9/12">
            <div>
              <p className="font-semibold text-purpurita">Análisis de datos</p>
            ...
            <Link
              ...
              className="flex items-center justify-center h-12 text-sm font-semibold duration-300 border-2 rounded-full w-44 border-purpurita text-purpurita hover:shadow-lg"
            >
              <p>Descubre más</p>
            </Link>
          </div>
