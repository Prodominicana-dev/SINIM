...
export default function page() {
  ...
  return (
    ...
    <Header
        ...
        message="Nuestra plataforma se nutre de una red diversa de fuentes externas para proporcionarte información precisa y actualizada. Explora enlaces a recursos de confianza y expertos en una variedad de campos, desde noticias y tendencias hasta investigaciones y datos relevantes."
      />
      <div className='flex flex-col w-full p-8 space-y-4'>
        ...
        <div className={`${filterVisible} flex flex-col-reverse  sm:flex-row justify-end w-full gap-4 sm:space-x-5 `}>
      <input
            type="text"
      ...
      <div className='grid grid-cols-1 place-items-center sm:gap-8 sm:p-8 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4'>
        {partners?.length === 0 ? (<NotFound />) : (
            ...
            {titleSearch === "" && categorySearch.label === "" ? (<>
                ...
                {partnersFiltered?.length === 0 ? (<NotFound />) : (<>
