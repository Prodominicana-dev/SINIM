...
<div>
      <div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="flex flex-col w-full p-4 space-y-2 sm:p-8 sm:space-y-0 sm:flex-row ">
            <div className="flex items-center justify-start w-full text-xl font-semibold text-center text-black sm:text-left sm:w-4/12">Cantidad de alertas de IED: {total}</div>
              ...
              <button
              onClick={handleOpen}
              className={total === 0  ? `flex items-center justify-center w-full h-10 gap-3 text-white duration-100 rounded-lg sm:rounded-full shadow-none bg-navy sm:w-44` : `hidden`}
              >
